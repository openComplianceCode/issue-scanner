...
class Down(object):
    ...
    #断点下载
    def downLoad(slef, url, filePath, retryTimes, proxies):
        '''
        :param url: 下载连接
        :param filePath: 下载路径
        ...
        count = 0
        #请求获取文件总大小
        topReq = requests.get(url, stream = True, verify = False, proxies = proxies)
        ...
        while count < retryTimes:
            ...
            downReq = requests.get(url, stream=True, verify=False, proxies=proxies, headers=headers)
